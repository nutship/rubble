...
export function addCodeBlocksCSS() {
    ...
    if (os.indexOf('Win') == 0)
    {
        ...
        // inline code
        addCssRule('.md-typeset p code, .md-typeset td code, .md-typeset blockquote code', 'font-family: Consolas; ')
        // text shadow
    ...
    else
    {
        ...
        // inline code
        addCssRule('.md-typeset p code, .md-typeset td code, .md-typeset blockquote code', 'font-family: Monaco-inside; font-size: 0.612rem;')
